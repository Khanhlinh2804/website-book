        ...
        <div class="row pt-5">
            <div class="col-lg-7">
                ...
                <div>
                    ...
                    <select class="checkout-input" id="exampleFormControlSelect1" name="city_id">
                    @foreach ($city as $item)
                        
                    <option value="{{$item->id}}" {{old('city')}} class="" > {{$item->name}}</option>
                    @endforeach
                ...
                <div>
                    <div class="pt-4">
                        <label class="checkout-first-name" >District<span style="color: red; font-weight: bold; ">*</span></label>
                    </div>
                    <select class="checkout-input" id="exampleFormControlSelect1" name="district">
                    @foreach ($district as $item)
                        <option value="{{$item->id}}" {{old('district')}} class="" >{{ $item->name }}</option>
                ...
                <div class="pt-5">
                    ...
                    <div>
                        <textarea class="checkout-input" name="note" placeholder="Notes about your order, e.g. special notes for delivery."></textarea>
                    </div>
            ...
            <div class="col-lg-5 pl-5">
                ...
                <div class="background-white">
                    <div class="p-3 pl-5">
                        <input type="checkbox" class="payment-method" name="status" value="cash-on-delivery"> Cash on delivery
                    </div>
                    <div class="checkout-divider"></div>
                    <div class="p-3 pl-5">
                        <input type="checkbox" class="payment-method" name="status" value="paypal"> Paypal
                        <img src="https://www.paypalobjects.com/webstatic/mktg/logo/AM_mc_vs_dc_ae.jpg" alt="" style="width: 110px;height: 40px;">
                    </div>
                    <div class="checkout-divider"></div>
                    <div class="p-3 pl-5">
                        <input type="checkbox" class="payment-method" name="status" value="elegro-crypto-payment"> elegro Crypto Payment
                    ...
                    <a href="" style="text-decoration: none">
                        <div class="button-center">
                            <button class="mb-5 p-3 pl-5 pr-5 bold-text pl-50 white-text black-backgroundS borderless-button" id="proceed-button">PROCEED TO PAYPAL</button>
                        </div>
                    </a>
                </div>
