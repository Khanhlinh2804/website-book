                        ...
                        @foreach ($author as $item)
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <a href="{{route('admin.author.restore',$item->id)}}" class="btn btn-outline-success">BACK</a>
                                    <a href="{{route('admin.author.deleteforce',$item->id)}}" class="btn btn-outline-success">CLEAD</a>
