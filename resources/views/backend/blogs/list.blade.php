        ...
        <div class="row">
             <?php $user = Auth::user(); ?>
                ...
                @if ($user->can('admin.blog.create') )
                    <a href="{{ route('admin.blog.create') }}" class="btn btn-outline-primary">ADD BLOG</a>
                @endif
                @if ($user->can('admin.blog.index') )
                    <a href="{{ route('admin.blog.trashed') }}" class="btn btn-outline-primary">TRASH</a>
                @endif
                        ...
                        @foreach ($blog as $item)
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <a href="{{route('admin.blog.edit',$item->id)}}" class="btn btn-outline-success">Edit</a>
