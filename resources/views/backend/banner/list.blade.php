                        ...
                        @foreach ($banners as $item)
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <a href="{{route('admin.banner.edit',$item->id)}}" class="btn btn-outline-success">Edit</a>
